        ...
        return (
            <div className="flex h-screen items-center justify-center bg-slate-50 p-6">
                <div className="bg-white p-12 rounded-[3.5rem] shadow-2xl shadow-indigo-900/10 border border-slate-100 max-w-md w-full text-center relative overflow-hidden group">
                    ...
                    <div className="w-24 h-24 bg-white rounded-3xl flex items-center justify-center mx-auto mb-10 relative p-4 overflow-hidden border border-slate-50 shadow-sm">
